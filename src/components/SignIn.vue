        ...
        <div class="relative pt-20">
            <div class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
                ...
                <section class="mt-5 grid grid-cols-3">
                    ...
                    <button disabled type="button" @click="loginWithGoogle"
                ...
                <section class="mt-5">
                    <form class="flex flex-col" @submit.prevent="loginWithEmail">
                        ...
                        <div class="mb-6 pt-3 rounded bg-gray-200">
                            <label class="block text-gray-700 text-sm font-bold mb-2 ml-3" for="password">账户密码</label>
                        ...
                        <div class="flex justify-end">
                            ...
                            <a href="#" class="flex-none text-sm text-right text-purple-600 hover:text-purple-700 hover:underline mb-6">忘记密码?</a>
                        </div>
                        <button
...
import { setPersistence, browserLocalPersistence, signInWithPopup, signInWithEmailAndPassword, createUserWithEmailAndPassword, updateProfile, GithubAuthProvider, OAuthProvider, GoogleAuthProvider } from 'firebase/auth'
