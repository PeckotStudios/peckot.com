<template>
    <div class="relative">
        <button class="z-10 relative flex items-center focus:outline-none select-none" @click="toggle">
            <slot name="button"></slot>
        </button>

        <!-- to close when clicked on space around it-->
        <button class="fixed inset-0 h-96 w-full cursor-default focus:outline-none" v-if="open" @click="toggle"></button>
