...
<template>
    <NotificationGroup group="bottom-right">
        <div class="fixed inset-0 flex place-items-end items-end justify-end p-6 px-4 py-6 pointer-events-none">
            <div class="w-full max-w-sm">
                <Notification v-slot="{ notifications }" enter="transform ease-out duration-200 transition"
                    enter-from="translate-y-2 opacity-0 sm:translate-y-0 sm:translate-x-4"
                    enter-to="translate-y-0 opacity-100 sm:translate-x-0" leave="transition ease-in duration-500"
                    leave-from="opacity-100" leave-to="opacity-0" move="transition ease-in duration-500" move-delay="delay-300">
