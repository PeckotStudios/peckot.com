        ...
        <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
            <div class="md:w-2/3 lg:w-1/2">
                ...
                <p class="text-gray-600 dark:text-gray-300">
                    由 Peckot Studios 或其附属小组开发并保持维护的相关作品
                </p>
            </div>
            <div
                ...
                <div
                    ...
                    <div class="relative space-y-8 py-12 p-8 transition bg-cover bg-peckotmc">
                        ...
                        <a href="https://mc.peckot.com/"
                            class="flex items-center justify-between text-gray-800 dark:text-white group-hover:text-secondary group-hover:dark:text-secondarydark">
