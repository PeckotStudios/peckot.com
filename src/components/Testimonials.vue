            ...
            <div class="md:columns-2 lg:columns-3 gap-8 space-y-8">
                <div
                    ...
                    <div class="flex gap-4">
                        <img class="w-12 h-12 rounded-full" src="https://q1.qlogo.cn/g?b=qq&nk=2671876934&s=640"
                            alt="Pectics' avatar" loading="lazy" draggable="false" />
                        <div>
                            <h6 class="text-lg font-medium text-gray-700 dark:text-white">Pectics</h6>
                            <p class="text-sm text-gray-500 dark:text-gray-300">Peckot Studios 创立者</p>
                        </div>
                    </div>
                    <p class="mt-8">直到如今我仍然认为 Peckot Studios
                        的创立是值得的，尽管它的管理层相关制度十分随意，但是作为学生，我们的热情是不易熄灭的，既然大家由于拥有共同兴趣爱好而聚集到了一起，又为何不奋斗一时建设属于自己内心的美好呢？</p>
                </div>
                <div
                    class="aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none">
                    <div class="flex gap-4">
                    ...
                    <p class="mt-8">2021年6月27日创立 Peckot Studios。那天，我们踏入了未曾设想的的道路。尽管身隔远方，但是我们的张力不断地拉拢着我们，正因如此，才砌起了我们心中那一座热情的圣殿、点燃了希望的冉冉篝火。</p>
                </div>
                <div
                    class="aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none">
                    <div class="flex gap-4">
                        <img class="w-12 h-12 rounded-full"
                            src="https://pbs.twimg.com/profile_images/1362367807887974401/kuJ1OFT1_400x400.jpg" alt=""
                    ...
                    <p class="mt-8">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Architecto laboriosam deleniti
                        aperiam
                        ab veniam sint non cumque quis tempore cupiditate. Sint libero voluptas veniam at reprehenderit,
                        veritatis
                        harum et rerum.</p>
                </div>
                <div
                    ...
                    <div class="flex gap-4">
                        <img class="w-12 h-12 rounded-full"
                            src="https://pbs.twimg.com/profile_images/1511686703672606725/_DV4Mfjd_400x400.jpg" alt=""
                            width="" height="" loading="lazy">
                        <div>
                ...
                <div
                    ...
                    <div class="flex gap-4">
                        <img class="w-12 h-12 rounded-full"
                            src="https://pbs.twimg.com/profile_images/1398547148086681604/ctgizwrN_400x400.jpg" alt=""
                            width="" height="" loading="lazy">
                        <div>
                    ...
                    <p class="mt-8"> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Architecto laboriosam
                        ...
                        reprehenderit,
                        veritatis harum et rerum.</p>
                </div>
                <div
                    class="aspect-auto p-8 border border-gray-100 rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none">
                    <div class="flex gap-4">
                        <img class="w-12 h-12 rounded-full" src="" alt="" width="" height="" loading="lazy">
                        <div>
